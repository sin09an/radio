...
<body>
	...
	<form action="conlist.do" method="post" name="sf">
	...
	<table>
		...
		<c:if test="${boardcnt > 0}">
			...
			<c:forEach var="b" items="${conlist}"> 
			 ...
			 <a href="conreqlist.do?num=${b.num}">${b.title}</a> 
					</td>				
		...
		<tr>
			<td colspan="7" style="text-align: right"><a href="conwriteForm.do">[글쓰기]</a></td>
		</tr>
	</table>
</body>
</html>
