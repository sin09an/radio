...
<table style="margin-top: 35px;"> 
  ...
  <tr>   
  <td colspan="2">  
  <form action="plus.do" name="f" method="post"> 
<input type="hidden" name="num" value="${b.num}">
  <input type="submit" value="추천하기" >   
  </form>
  <a href="conlist.do">[목록]</a> 
  </td>
  </tr>
</table>
<br><br><br><br><br><br><br><br>
<form action="conreview.do?num=${b.num}" method="post" name="f"> 
<input type="hidden" name="num" value="${b.num}">  
...
<input type="hidden" name="boardtype" value="3">  
	...
	<hr style="border:none; border:3px dashed #993300;"> 
	  <table>
